...
public class GetProductInfo5Command extends HystrixCommand<ProductInfo> {
    private Long productId;

    public GetProductInfo5Command(Long productId){
       // super(HystrixCommandGroupKey.Factory.asKey("GetProductInfoGroup"));
        super(Setter.withGroupKey(HystrixCommandGroupKey.Factory.asKey("ProductInfoService")) // group name
                ...
                .andCommandPropertiesDefaults(HystrixCommandProperties.Setter()
                        ...
                        .withExecutionTimeoutInMilliseconds(500) // 超时时间设置为5毫秒 --> 超时测试
